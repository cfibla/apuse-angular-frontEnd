...
export class ModalEeAlumneComponent implements OnInit {
  ...
  constructor(public alumneService: AlumneService,
    ...
    private modalService: NgbModal,
      ...
      console.log("USER-EE", this.usuari);
     }
     ...
     ngOnInit(): void {
      this.dadesAlumne = new FormGroup({
        ...
        piCurricular: new FormControl(this.alumneFill.piCurricular),
        piMetodologic: new FormControl(this.alumneFill.piMetodologic),
        piConductual: new FormControl(this.alumneFill.piConductual),
  ...
  obrirEeModal(content) {
    this.modalService.open(content, {ariaLabelledBy: 'modal-ee-alumne', size: 'lg'}).result.then((res) => {
      // Al tancar amb DESA...
      this.pujarAlumne();
    }, (res) => {
